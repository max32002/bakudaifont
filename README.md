「莫大毛筆字體」是基於[衡山毛筆フォント](https://opentype.jp/kouzanmouhitufont.htm)的開放原始碼中文字型。衡山毛筆字體是來自於日本書法家青柳衡山，修改前文字＋符號數約：13,000字，修改後文字＋符號數：24,896字。
...
目前完整新增字略長，中文字的部份新增6,338字，字數太多，請參考文字檔 [added_glyph.txt](https://github.com/max32002/bakudaifont/raw/master/added_glyph.txt)。
