「莫大毛筆字體」是基於[衡山毛筆フォント](https://opentype.jp/kouzanmouhitufont.htm)的開放原始碼中文字型。衡山毛筆字體是來自於日本書法家青柳衡山，修改前文字＋符號數約：13,000字，修改後文字＋符號數：24,896字，增加11,281字符。歡迎大家自由應用、自由優化、自由改作！
